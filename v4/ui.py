...
def create_ui():
    ...
    back_to_menu_button = ttk.Button(frm, text=lang_center.translate("MENU"), command=lambda: back_to_menu(frm, view_all_button, add_button, search_button, view_stats_button, lang_center, settings_button))
